# This service writes data to the elasticsearch database and can be used for querying ,the interaction is through an api layer
...
## only one of the branches work , use the with_async_elasticsearch branch 
